...
class CoreDataManager: NSObject {
    ...
    private init() {
        ...
        todosFRC = NSFetchedResultsController<NSFetchRequestResult>(fetchRequest: todoFR,
        ...
        projectsFRC = NSFetchedResultsController<NSFetchRequestResult>(fetchRequest: projectFR,
                                                 managedObjectContext: managedObjectContext,
                                                 sectionNameKeyPath: nil,
                                                 cacheName: nil)
